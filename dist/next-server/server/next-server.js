...
class Server {
                ...
                return {
                    ...
                    fn: async (_req, res, params, _parsedUrl) => {
                        ...
                        if (route.type === 'redirect') {
                            ...
                            res.setHeader('Location', url_1.format(Object.assign(Object.assign({}, parsedDestination), { pathname: parsedNewUrl.pathname, hash: parsedNewUrl.hash })));
    ...
    async handleApiRequest(req, res, pathname) {
        ...
        await api_utils_1.apiResolver(req, res, params, pageModule, this.onErrorMiddleware);
        return true;
    }
